...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class NewWeather :  IEquatable<NewWeather>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewWeather" /> class.
        /// </summary>
        ...
        public NewWeather(DateTime? date = default(DateTime?), float? temperature = default(float?), float? presure = default(float?), float? cloudCover = default(float?), float? rainFall = default(float?))
        {
            this.Date = date;
        ...
        {
            return this.Equals(input as NewWeather);
        }

        /// <summary>
        /// Returns true if NewWeather instances are equal
        /// </summary>
        /// <param name="input">Instance of NewWeather to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewWeather input)
        {
            if (input == null)
                return false;
